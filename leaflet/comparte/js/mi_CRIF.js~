...
$(document).ready(function () {        
	...
	//var url = "http://www.smartcitything.es:8080/ServiceGeoJson/ProveedorSensorHoras?horas=120&sensor=temperatura&proveedor=OE_CRIF_ACACIAS&fin=1434369359000";
    var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID=OE_CRIF_ACACIAS&sensorID=temperatura&rango=120&fin=1434369359000"
...
$(document).ready(function () {        
        ...
        var xmlhttp = new XMLHttpRequest();
	//var url = "http://www.smartcitything.es:8080/ServiceGeoJson/ProveedorSensorHoras?horas=120&sensor=humedad&proveedor=OE_CRIF_ACACIAS&fin=1434369359000";
var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID=OE_CRIF_ACACIAS&sensorID=humedad&rango=120&fin=1434369359000";
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                myArr = JSON.parse(xmlhttp.responseText);
            }
