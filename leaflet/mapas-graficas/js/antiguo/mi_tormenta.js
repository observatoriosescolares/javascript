...
$(document).ready(function () {        
	...
	//var url = "http://www.smartcitything.es:8080/ServiceGeoJson/ProveedorSensorHoras?horas=92&sensor=temperatura&proveedor="+proveedor+"&fin=-1";
	...
	var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID=OE_CRIF_ACACIAS&sensorID=temperatura&rango=200&fin=1460270105000"
	...
	//la última marca de tiempo corresponderá a "a" ya que van en orden
        ...
        var plot6 = $.jqplot("graf1",  [line4], {
			...
			//yaxis:{min: 0, max: 40, tickOptions:{formatString:'%.0fºC'}}},
...
$(document).ready(function () {        
	...
	var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID=OE_CRIF_ACACIAS&sensorID=humedad&rango=200&fin=1460270105000"
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                myArr = JSON.parse(xmlhttp.responseText);
            }
...
$(document).ready(function () {        
	...
	var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID=OE_CRIF_ACACIAS&sensorID=presion&rango=200&fin=1460270105000"
    xmlhttp.onreadystatechange = function() {
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            myArr = JSON.parse(xmlhttp.responseText);
        }
    ...
    if( myArr.hasOwnProperty("NULL")){
	   ...
	   //la última marca de tiempo corresponderá a "a" ya que van en orden
        ...
        var plot6 = $.jqplot("graf3",  [line4], {
            title : "Presión atmosférica "+proveedor+". Max: "+ maximo + " hPa, Min: " + minimo + " hPa y Media: " + media.toFixed(1),
            axesDefaults: {
        		tickRenderer: $.jqplot.CanvasAxisTickRenderer ,
        		tickOptions: {
          			angle: -20,
