...
//var nombre = nombre_con.replace(/++/g, ' ');;
...
$(document).ready(function () {        
	...
	var url = "http://www.smartcitything.es:8080/ServiceJson/JsonSensorObservations?proveedorID="+proveedor+"&sensorID=temperatura&rango="+rango;
	...
	//la última marca de tiempo corresponderá a "a" ya que van en orden
        ...
        var plot6 = $.jqplot("graf1",  [line4], {
		    title : "Temperatura: "+nombre+". Max: " + maximo +"ºC, Min: " + minimo + "ºC, "+ "Media: "+ media.toFixed(1),
		    axesDefaults: {
