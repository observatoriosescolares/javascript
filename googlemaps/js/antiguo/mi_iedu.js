        ...
        var plot6 = $.jqplot("graf1",  [line4], {	
		    ...
		    axesDefaults: {
        		...
        		tickOptions: {
                    ...
                    axes: {
                        xaxis:{min:inicio, max:a, renderer: $.jqplot.DateAxisRenderer,tickOptions: { formatString: '%#d %b, %H:%M', angle: -20}, 										tickInterval: '0.2 hour', 
                        ...
                        yaxis:{min:parseInt(minimo) - 2, max:parseInt(maximo) + 2, tickOptions:{formatString:'%.0f'},
